<!--
  ...
  At build time (`npm run build`), scripts/generate-llms.mjs overwrites
  dist/ai/publications.md from src/content/{blog,books}/*.md frontmatter.
  This public/ai/publications.md is a legacy fallback only; edits here
  do NOT reach https://kenimoto.dev/ai/publications.md.
  Edit src/content/books/*.md frontmatter or scripts/generate-llms.mjs instead.
-->
