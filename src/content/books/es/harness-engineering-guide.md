...
kindle_url: "https://www.amazon.com.mx/dp/B0GXSVHZ5G"
...
cover_image: "/images/books/harness-engineering-guide-es.jpg"
...
competitor_comparison:
  - book: "Documentación de los vendors (OpenAI / Anthropic / LangChain)"
    difference: "No es la visión de un solo vendor. Aquí las 5 interpretaciones se integran, y el libro explica por qué divergen."
  - book: "Libros de Prompt / Context Engineering"
    difference: "Aborda la capa por encima del prompt y el contexto — el tercer nivel de la pila."
  - book: "Guías de Agent Framework (LangChain Agents etc.)"
    difference: "No es específico de framework. Mapea la frontera entre harness y Agent Frameworks."
...
chapters:
  ...
  - title: "La perspectiva de Martin Fowler — El harness implícito en tu base de código"
  - title: "La perspectiva académica — Artículos en arXiv y especificación formal"
  - title: "Los seis componentes — Anatomía de un harness"
    free: true
  - title: "Mapa de tecnologías cercanas — Vibe Coding / Spec Coding / Agent Frameworks"
  - title: "Reconciliando las interpretaciones — Qué hay en común, qué no"
  - title: "Diseñando AGENTS.md / CLAUDE.md en la práctica"
  - title: "Hooks / Ciclo de vida / Loops de retroalimentación"
  - title: "Self-Evolving Agents — Un harness que se mejora a sí mismo"
  - title: "El futuro de la Harness Engineering"
  - title: "Posfacio"
  - title: "Referencias"
    free: true
