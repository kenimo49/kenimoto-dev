...
Se quiser ir mais fundo no ciclo de vida de hooks e nos workflows diários de Claude Code, escrevi mais sobre isso nos meus livros (*Harness Engineering Guide* e *Claude Code Mastery*) — o capítulo de hooks/feedback-loops do primeiro e o de workflow diário do segundo são os mais próximos do que descrevi aqui.
