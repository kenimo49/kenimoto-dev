...
- [安い方のモデルが勝った: コンテキストはパラメータに勝る](https://kenimoto.dev/ja/blog/cheap-model-won-context-beats-parameters) — 別領域の同じ教訓。アーキテクチャはモデルサイズを食う
...
[音声AI 300ms UX: 会話の崖を設計する](https://kenimoto.dev/ja/books/voice-ai-300ms-ux?utm_source=kenimoto-dev-blog&utm_medium=article&utm_campaign=voice-ai-5-stacks-300ms)
