...
10の技法の元になる思考プロセスと原文での定式化は [Debugging Engineering](https://kenimoto.dev/ja/books/debugging-engineering?utm_source=kenimoto-dev-blog&utm_medium=article&utm_campaign=claude-bug-kakushi-debug-10) で1冊にしました。プロンプト変換の章と次節のCLAUDE.md/hooks装備の章は、本記事の骨格そのものです。
...
10の技法をプロンプトに翻訳する章と、CLAUDE.md/hooks/MCPを3層で組む章は、[Debugging Engineering](https://kenimoto.dev/ja/books/debugging-engineering?utm_source=kenimoto-dev-blog&utm_medium=article&utm_campaign=claude-bug-kakushi-debug-10) にまとめてあります。
